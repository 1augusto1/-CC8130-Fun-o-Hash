...
# Cabeçalho da tabela
print("{:<120} {:<20} {:<20} {:<20}".format("Frase", "SHA256 (Esperado)", "MD5 (Esperado)", "Resultado"))
print("-" * 180)

# Verificar as frases e seus hashes
for frase, sha256_hash, md5_hash in frases:
    SHA256 = hashlib.sha256(frase.encode('utf-8')).hexdigest()
    MD5 = hashlib.md5(frase.encode('utf-8')).hexdigest()

    resultado_sha256 = "Correto" if SHA256 == sha256_hash else "Incorreto"
    resultado_md5 = "Correto" if MD5 == md5_hash else "Incorreto"

    resultado_final = "Verdadeira" if resultado_sha256 == resultado_md5 == "Correto" else "Falsa"

    print("{:<120} {:<20} {:<20} {:<20}".format(frase, resultado_sha256, resultado_md5, resultado_final))
